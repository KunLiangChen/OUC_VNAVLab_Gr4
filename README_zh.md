...
---
# 🛠️ 设备维护与修复 (Troubleshooting)

集成小组项目使用Jetson Orin NX开发板。我们的 **Jetson Orin NX** 出现无法启动、固件损坏或系统崩溃等问题，我们进行了修复，下面记录了修复过程和解决方案以供参考：

**[解决方案](https://foremost-garage-64a.notion.site/Jetson-Orin-NX-32d3024d444380bea5e8e50f9d7ee834?pvs=143)**
---
